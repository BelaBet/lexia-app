...
// invite-company-member) para um usuário de empresa definir a senha.
export default function EmpresaSetPassword() {
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-border/50 shadow-xl">
          <CardHeader>
            ...
            <CardDescription>
              {hasSession
                ? "Escolha uma senha para acessar sua conta a partir de agora."
